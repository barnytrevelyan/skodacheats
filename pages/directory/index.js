...
export default function DirectoryIndex({ countries }) {
  ...
  const jsonLd = {
    ...
    '@type': 'ItemList',
    name: BRAND.name + ' Global Recourse Directory',
    description: 'Country-by-country consumer recourse guide for billing disputes',
    numberOfItems: countries.length,
    itemListElement: countries.map((c, i) => ({
      '@type': 'ListItem',
      position: i + 1,
      name: `${c.flag_emoji || ''} ${c.name} — ${BRAND.targetProduct} Recourse Guide`,
  ...
  return (
    <>
      <Head>
        <title>{BRAND.meta.directoryTitle}</title>
        <meta name="description" content={BRAND.meta.directoryDescription} />
        ...
        <div className="relative bg-gray-900 text-white py-14 px-4 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              ...
              that can actually get your money back.
            </p>
          </div>
        </div>
        ...
        <main id="main-content" className="max-w-6xl mx-auto px-4 py-12 sm:px-6">
          ...
          <section className="mb-12 grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
            {[
              ...
              { icon: '💳', title: 'Part B: Payment Partners', desc: 'The financial infrastructure used in your country — and how to dispute charges through it.' },
          ...
          <section className="mt-8 p-4 bg-gray-50 border border-gray-200 rounded text-xs text-gray-500">
            ...
            addresses are listed. {BRAND.disclaimer.legalNotice}
          </section>
        </main>
